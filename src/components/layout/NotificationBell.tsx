...
export function NotificationBell() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="relative w-8 h-8 rounded-full bg-accent flex items-center justify-center hover:bg-accent/80 transition-colors outline-none">
