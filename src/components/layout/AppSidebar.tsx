  ...
  return items.map((item) => {
    ...
    return (
      <button
        ...
        className="relative w-full h-[44px] text-[13px] transition-colors group gap-[12px] px-[16px] flex-row flex items-center justify-start"
        style={{
