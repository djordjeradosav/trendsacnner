...
import {
  LayoutDashboard, Radar, LineChart, Bell, Star, Settings, LogOut, Menu, X,
} from "lucide-react";
...
export function MobileMenuButton() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[100] bg-background flex flex-col animate-in slide-in-from-right duration-200">
